...
export default function EndingsPage() {
  const jsonLd = [
    { "@context": "https://schema.org", "@type": "Article", headline: "Drag'n Wash Endings: Conrad, Ryan and Alexander Routes", description: "Plan Drag'n Wash endings with Conrad, Ryan and Alexander routes, filmed decisions, route locks and replay steps.", image: `${siteUrl}/images/og-image.png`, dateModified: "2026-09-23", mainEntityOfPage: `${siteUrl}/endings`, publisher: { "@type": "Organization", name: siteName } },
  ...
  return (
    <main className={`container inner-page ${inner.endingsPage} ${styles.page}`}>
      ...
      <InnerPageHero
        ...
        imageAlt="Late Drag'n Wash scene used to introduce the ending routes"
      ...
      <div className={styles.spoilerWarning} role="note">
        ...
        <div><strong>Full spoiler warning</strong><p>This page names late relationship choices and outcomes. It does not hide the routes behind accordions, so stop here if you want a blind first run.</p></div>
      </div>
      ...
      <div className={`${inner.articleGrid} ${styles.endingsGrid}`}>
        <article className={`${inner.article} ${styles.article}`}>
          <section id="ending-routes" className={styles.treeSection}>
            <EndingRouteMap />
          </section>

          <section id="conrad-route" className={styles.routeSection}>
            <div className={styles.routeCopy}>
              <div className={styles.routeHeading}><span className={styles.routeNumber}>01</span><div><p className={styles.kicker}>FILMED ROUTE LOCK</p><h2>Conrad Route</h2></div></div>
          ...
          <section id="ryan-route" className={styles.routeSection}>
            ...
            <div className={styles.routeCopy}>
              <div className={styles.routeHeading}><span className={styles.routeNumber}>02</span><div><p className={styles.kicker}>PICNIC DECISION</p><h2>Ryan Route</h2></div></div>
          ...
          <section id="ryan-conrad-route" className={styles.routeSection}>
            <div className={styles.routeCopy}>
              <div className={styles.routeHeading}><span className={styles.routeNumber}>03</span><div><p className={styles.kicker}>TWO ENTRY POINTS</p><h2>Ryan–Conrad Route</h2></div></div>
          ...
          <section id="alexander-route" className={styles.routeSection}>
            ...
            <div className={styles.routeCopy}>
              <div className={styles.routeHeading}><span className={styles.routeNumber}>04</span><div><p className={styles.kicker}>LATE RELATIONSHIP CHECK</p><h2>Alexander Route</h2></div></div>
        ...
        <aside className={`${inner.sidebar} ${styles.sidebar}`}>
          <div className="panel"><p className="eyebrow">ROUTE INDEX</p><p className={inner.sidebarTitle}>On this page</p><a href="#ending-routes">Ending routes →</a><a href="#conrad-route">Conrad route →</a><a href="#ryan-route">Ryan route →</a><a href="#ryan-conrad-route">Ryan–Conrad pairing →</a><a href="#alexander-route">Alexander route →</a><a href="#what-counts">What counts as an ending? →</a><a href="#replay-all-endings">Replay all three endings →</a><a href="#faq">Endings FAQ →</a></div>
