...
export const searchIndex: SearchItem[] = [
  ...
  { title: "Gameplay, Stores & Content", description: "How the game plays, where to buy it and what to expect.", href: "/#gameplay", category: "Game", keywords: "gameplay what is it download full game free Steam itch GOG platforms Windows macOS Linux adult porn nudity vore uncensored SFW censored" },
