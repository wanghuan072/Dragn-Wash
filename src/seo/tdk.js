...
export const pageTdk = {
  ...
  troubleshooting: { title: "DRAG'N WASH Help - Fix Stuck Washes & Softlocks", description: "Fix Drag'n Wash launch errors, softlocks, a full clean bar that will not advance, missing audio, save trouble, and performance issues with symptom-first steps." },
