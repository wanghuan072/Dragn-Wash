...
export const pageTdk = {
  ...
  endings: { title: "DRAG'N WASH Endings - Choice Tree & Route Guide", description: "Follow the Drag'n Wash ending choice tree for Conrad, Ryan, Alexander and the Ryan–Conrad pairing, with filmed decisions, route locks and replay steps." },
