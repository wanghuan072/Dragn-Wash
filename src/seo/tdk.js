...
export const pageTdk = {
  ...
  endings: { title: "DRAG'N WASH Endings - Conrad, Ryan & Alexander Routes", description: "Plan Drag'n Wash endings with Conrad, Ryan and Alexander routes, including filmed decisions, route locks, the Ryan–Conrad pairing and replay steps." },
