...
export const pageTdk = {
  ...
  dragons: { title: "DRAG'N WASH Characters - Alexander, Ryan & Conrad", description: "Meet every Drag'n Wash dragon with practical profiles for Alexander, Ryan, and Conrad, including their visits, interactions, relationships, and route notes." },
  endings: { title: "DRAG'N WASH Endings - Every Choice and Route", description: "Follow Drag'n Wash endings through every filmed Conrad, Ryan and Alexander choice, with full menus, cross-character branches, scene results and replay steps." },
