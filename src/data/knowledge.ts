...
export const knownIssues: IssueRecord[] = [
  ...
  { id: "movement-lock", title: "Kobold cannot move or interact", symptoms: ["stuck", "softlock", "movement", "input"], platform: "All", status: "Check current build", firstAction: "Pause and use Unstick Kobold, which was added in the September 13 hotfix.", nextAction: "If the same steps reproduce the lock after updating, record the scene, character and platform.", evidence: "Official", relatedHref: "/troubleshooting/stuck-softlock", sourceUrl: "https://steamcommunity.com/app/4739660/allnews/" },
  ...
  { id: "linux-nvidia", title: "Native Linux graphics issue on Nvidia", symptoms: ["linux", "nvidia", "graphics", "launch"], platform: "Linux", status: "Fixed", firstAction: "Install the September 13 hotfix or newer.", nextAction: "Check current drivers and test the unmodified game before reporting a regression.", evidence: "Official", relatedHref: "/troubleshooting/launch-performance#performance", sourceUrl: "https://steamcommunity.com/app/4739660/allnews/" },
...
export const screenshotRecords: ScreenshotRecord[] = [
  ...
  { id: "red-dragon-dialogue", title: "Red dragon dialogue", category: "Story", image: "/images/home/steam-4.webp", alt: "Red dragon speaking to the player inside the wash station", caption: "Dialogue and requests continue around the washing sequences.", relatedHref: "/dragons/conrad", relatedLabel: "Conrad notes" },
  ...
  { id: "character-reaction", title: "Character reaction", category: "Story", image: "/images/home/steam-10.webp", alt: "Pale dragon reacting during an in-game conversation", caption: "Story prompts and character reactions can signal the next objective after washing.", relatedHref: "/dragons#story-moments", relatedLabel: "Dragon story moments" },
